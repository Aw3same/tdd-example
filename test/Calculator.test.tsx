...
import { Calculator, operations, equalSign, numbers } from '../src/Calculator'
...
describe('Calculator', (): void => {
  ...
  it('should show user inputs after clicking numbers and operations', (): void => {
    render(<Calculator />)
  ...
  it('should calculated based on user input and show the calculation', (): void => {
    render(<Calculator />)
